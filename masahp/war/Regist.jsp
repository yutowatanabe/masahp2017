...
<title>HILO-SENDAI TOURS　会員登録</title>
</head>
<body>
	<div id="container">
		<div id="header">
		...
		<div id="contents">
			...
			<div id="conR">
				...
				<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdEySwEQmGmW8GW4AHZcggsLufEeiUtG4AtEK7DwrX1wcjJUw/viewform?embedded=true" width="600" height="800" frameborder="0" marginheight="0" marginwidth="0">読み込んでいます...</iframe>
				</div>
				<!-- /.information -->
				<h3>イベント・情報</h3>
