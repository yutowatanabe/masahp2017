		...
		<div id="contents">
			...
			<div id="conR">
				...
				<div class="information">
					<h1><center>オプショナルツアー　一覧</center></h1>
					<p>

					<div id="planname" >
						▼ ４時間プラン  $150 (1名～3名)
						<br>
						<div align ="right">*4名から1名追加料金$50</div>
					</div>
					<div>
						<h3><font size = "4" color ="blue">Aコース</font></h3>
						...
						<h3><font size = "4" color ="green">Bコース</font>
							</h3><font size ="4">州立公園ツアー（レインボー滝・ラヴァーツリー・アハラヌイ）
						...
						<h3><font size = "4" color ="#FF0099">Cコース</font></h3>
						...
						<h3><font size = "4" color ="red">Dコース</font></h3>
...
<p>
					...
					<div id="planname" >
						▼ ６時間プラン $250 (1名～3名)
						<br>
						<div align ="right">*4名から1名追加料金$70</div>
						</div>
					<div>

						<h3><font size = "4" color ="blue">Aコース</font></h3>
							<font size ="4">ノースツアー（ダウンタウン・アカカ大滝・ホノカアタウン）
							<br>＊映画になった町を観たりハワイ島の古き良き町を散策しよう</font>
							<ul class="bxslider">
							<li><img src="images/planImage/6A_002.jpg"></li>
							<li><img src="images/planImage/6A_003.jpg"></li>
							<li><img src="images/planImage/6A_004.jpg"></li>
							</ul>
						<h3><font size = "4" color ="green">Bコース</font></h3>
						<font size ="4">キラウエアツアー(キラウエア)
							<br>＊昼のキラウエアを観てトレッキングを楽しみましょう</font>
							<ul class="bxslider">
							<li><img src="images/planImage/6B_003.jpg"></li>
							<li><img src="images/planImage/6B_002.jpg"></li>
							</ul>
						<h3><font size = "4" color ="#FF0099">Cコース</font></h3>
						<font size ="4">ラバーツアー（カラパナ）
							<br>＊ラバーの上をトレッキングしながら溶岩を観に行こう</font>
							<ul class="bxslider">
							<li><img src="images/planImage/6C_004.jpg"></li>
							<li><img src="images/planImage/6C_001.jpg"></li>
							<li><img src="images/planImage/6C_002.jpg"></li>
							</ul>
					</div>
					...
					<div id="planname">
						▼ ８時間プラン $300 (1名～3名)
						<br>
						<div align ="right">*4名から1名追加料金$90</div>
						</div>
					<div>
						<h3><font size = "4" color ="blue">Aコース</font></h3>
						<font size ="4">コナツアー（コナ）
						<br>＊コナでショッピングや観光を楽しんでいただきます</font>
							<ul class="bxslider">
							<li><img src="images/planImage/8A_001.jpg"></li>
							<li><img src="images/planImage/8A_002.jpg"></li>
							<li><img src="images/planImage/8A_003.jpg"></li>
							<li><img src="images/planImage/8A_004.jpg"></li>
							</ul>
						<h3><font size = "4" color ="green">Bコース</font></h3>
						<font size ="4">サウスツアー（カウ・ブラックサンドビーチ・サンセット）
						<br>＊コーヒーを楽しんだり亀を見たりサンセットまで楽しめるかも</font>
						<ul class="bxslider">
							<li><img src="images/planImage/8B_001.jpg"></li>
							<li><img src="images/planImage/8B_002.jpg"></li>
							<li><img src="images/planImage/8B_003.jpg"></li>
							<li><img src="images/planImage/8B_005.jpg"></li>
							<li><img src="images/planImage/8B_006.jpg"></li>
					...
					<div id="planname">
						▼ ＷＡＫＩＷＡＫＩＴＯＵＲ $380 1名～3名
						<br>
						<div align ="right">*4名から1名追加料金$80</div>
						</div>
					<div size = "4">
						<h3>こちらのプランはドライバーが天候などを考慮しての一日ミステリーツアーとなります。</h3>
							<ul class="bxslider">
							<li><img src="images/planImage/8A_003.jpg"></li>
							<li><img src="images/planImage/4A_005.jpg"></li>
							<li><img src="images/planImage/4C_005.jpg"></li>
					...
					<li>
						<div class="topNavi">
							...
							<div class="bnrRCon">
								...
								<p>＊各オプションには食事は含まれませんが御相談対応致します。</p>
								<p>＊天候に応じてコースが変更される場合があります。</p>
								<p>＊ゴルフ・アクティビティー・ホテルの予約なども承ります。</p>
								<p>＊チャーター料金はお問い合わせください。</p>
								<p>＊空港からの送迎もいたしますので、お問い合わせください。</p>
								<p>＊お支払い（現地係員へ現金にてお支払いください）</p>
							</div>
						</div>
					</li>
					<li>
