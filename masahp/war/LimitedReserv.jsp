...
<title>HILO-SENDAI TOURS　バケーションレンタル予約</title>
</head>
<body>
	<div id="container">
		<div id="header">
		...
		<div id="contents">
			...
			<div id="conR">
				...
				<div class="information">
					<h3>バケーションレンタル予約</h3>
					<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSeq_511XCDV3UzumLmmxk_nOhqLYqBO9rcWJzajAEN2WT1qSg/viewform?embedded=true" width="600" height="800" frameborder="0" marginheight="0" marginwidth="0">読み込んでいます...</iframe>
				</div>
				<!-- /.information -->
				<h3>イベント・情報</h3>
